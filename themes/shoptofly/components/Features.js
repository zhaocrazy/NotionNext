...
export const Features = () => {
  return (
    <>
      ...
      <section className='pb-8 pt-20 bg-[#f6f1eb] dark:bg-dark lg:pb-[70px] lg:pt-[120px]'>
          ...
          <div className='-mx-4 flex flex-wrap'>
            <div className='w-full px-4 md:w-1/2 lg:w-1/4'>
              <div className='wow fadeInUp group mb-12' data-wow-delay='.1s'>
                <div className='mx-auto relative z-10 mb-10 flex h-[70px] w-[70px] items-center justify-center rounded-[14px] bg-[#9bc459]'>
                ...
                <h4 className='text-center mb-3 text-xl font-bold text-dark dark:text-white'>
                  {siteConfig('STARTER_FEATURE_1_TITLE_1')}
                </h4>
                <p className='text-center mb-8 text-body-color dark:text-dark-6 lg:mb-9'>
                  {siteConfig('STARTER_FEATURE_1_TEXT_1')}
                </p>
                {/* <SmartLink
                  href={siteConfig('STARTER_FEATURE_1_BUTTON_URL', '')}
                  className='text-base font-medium text-dark hover:text-[#9bc459] dark:text-white dark:hover:text-primary'>
